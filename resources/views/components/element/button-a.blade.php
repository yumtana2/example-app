...
@php
    if (!function_exists('getThemeClassFroButtonA')){
        function getThemeClassFroButtonA($theme){
            return match ($theme){
...
<a href="{{ $href }}"
   ...
   focus:outline-none focus:ring-2 focus:ring-offset-2 {{ getThemeClassFroButtonA($theme) }}">
    {{ $slot }}
</a>
